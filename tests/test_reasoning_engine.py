...
from src.reasoning.compatibility_reasoner import (
    CompatibilityReasoner, CompatibilityStatus, CompatibilityIssue
)
from src.reasoning.semantic_search import SemanticSearch, HistoricalQuery
...
def test_compatibility_reasoner():
    ...
    result = reasoner.check_upgrade_compatibility(
        current_version='1.335',
        target_version='1.330'
    )
    ...
    result = reasoner.check_upgrade_compatibility(
        current_version='1.320',
        target_version='1.325'
    )
...
def test_semantic_search():
    ...
    similar = search.find_similar_versions('1.332', ['1.330', '1.331', '1.332', '1.333', '1.334', '1.335'])
...
def test_historical_queries():
    ...
    hist.add_compatibility_history('1.330', '1.330', True, 'Release Notes', '2024-01-15')
    hist.add_compatibility_history('1.330', '1.325', True, 'Release Notes', '2024-01-15')
...
def test_query_processor():
    ...
    parsed = processor.process_query("Can I run extension custom-logging on ActiveGate 1.335?")
