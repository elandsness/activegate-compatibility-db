...
class CompatibilityReasoner:
    ...
    def check_upgrade_compatibility(
        ...
        if use_graph and self.graph_query:
            graph_result = self._check_via_graph(
                current_version, target_version,
                managed_cluster_version, os_family, extensions
            )
    ...
    def _check_os_compatibility(self, ag_version: str, os_family: str, os_version: str = None) -> tuple:
    ...
    def _check_managed_cluster_compatibility(self, ag_version: str, managed_version: str) -> tuple:
    ...
    def _check_extension_compatibility(self, ag_version: str, extensions: List[Dict]) -> tuple:
    ...
    def _check_via_graph(self, current: str, target: str, managed: str = None, 
                         os: str = None, extensions: list = None) -> Dict:
    ...
    def _determine_status(self, issues: List[CompatibilityIssue], 
                         warnings: List[CompatibilityIssue]) -> CompatibilityStatus:
    ...
    def _generate_recommendations(self, issues: List[CompatibilityIssue],
                                  warnings: List[CompatibilityIssue]) -> List[str]:
    ...
    def _calculate_confidence(self, issues: List[CompatibilityIssue],
                             warnings: List[CompatibilityIssue]) -> float:
