...
class SemanticSearch:
    ...
    def find_similar_versions(
        self, version: str, all_versions: List[str]
...
class HistoricalQuery:
    ...
    def add_version_history(
        self, version: str, release_date: str, eos_date: str = None
    ):
        """
    ...
    def is_version_supported(self, version: str, check_date: str = None) -> Dict:
        ...
        if version not in self.version_history:
            return {"supported": False, "reason": "Version not in history"}
    ...
    def get_compatibility_at_time(
        self, ag_version: str, managed_version: str, check_date: str = None
    ) -> Optional[bool]:
        """
