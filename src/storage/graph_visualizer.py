...
class GraphVisualizer:
    ...
    def get_graph_data(self, 
                       ...
                       limit: int = 50) -> GraphVisualizationData:
        """
    ...
    def _sanitize_id(self, raw_id: str) -> str:
        ...
        safe = raw_id.replace('.', '_').replace('-', '_').replace(':', '_').replace(' ', '_')
        return safe
...
def visualize_graph(activegate_versions: Optional[List[str]] = None,
    ...
    data = visualizer.get_graph_data(activegate_versions=activegate_versions, limit=limit)
